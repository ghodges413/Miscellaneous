...
class Material {
public:
	virtual bool Scatter( const Ray & ray, const hitRecord_t & record, Vec3d & albedo, Ray & scattered, float & pdf ) const = 0;
...
public:
	...
	virtual bool Scatter( const Ray & ray, const hitRecord_t & record, Vec3d & abledo, Ray & scattered, float & pdf ) const override;
...
public:
	...
	virtual bool Scatter( const Ray & ray, const hitRecord_t & record, Vec3d & attenuation, Ray & scattered, float & pdf ) const override;
