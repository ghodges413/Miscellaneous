...
const Matrix & Matrix::Transpose() {
	std::swap( column0[ 1 ], column1[ 0 ] );
	std::swap( column0[ 2 ], column2[ 0 ] );
	std::swap( column0[ 3 ], column3[ 0 ] );

	std::swap( column1[ 2 ], column2[ 1 ] );
	std::swap( column1[ 3 ], column3[ 1 ] );

	std::swap( column2[ 3 ], column3[ 2 ] );
	return *this;
}
